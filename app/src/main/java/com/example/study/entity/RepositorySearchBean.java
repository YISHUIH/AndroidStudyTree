...
public class RepositorySearchBean {
    ...
    public static class ItemsBean {
         ...
         * contents_url : https://api.github.com/repos/JakeWharton/butterknife/contents/{+leftPath}
